...
That takes the Claude Code wiring back out and **keeps your memory**. `--park` moves the
directory aside under a dated name, `--delete-memories` destroys it after counting what is
...
directory with no copy of this repository on its PATH — and runs 57 checks in about five
