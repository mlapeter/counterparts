...
See the PR for the final counts on a clean detached checkout of the branch head (with and
without the weights env vars). The recall suites build their stores with stub embedders,
