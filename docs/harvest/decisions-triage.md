...
| 08-05 Observer read-only | An instrument strengthens nothing AND deposits nothing | KEEP-AS-EARNED | Caught in the act: the 08-04 probe wrote an episode file into the live store while "measuring" it. Fail direction is toward standing down. |
